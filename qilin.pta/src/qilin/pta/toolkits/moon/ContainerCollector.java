...
public class ContainerCollector {
    ...
    protected final MultiMap<AllocNode, SparkField> containerToFields = Maps.newConcurrentMultiMap();
    ...
    public void collect(){
        Set<AllocNode> toBeDetermined = Sets.newConcurrentSet();
    ...
    private boolean qilinHack(AllocNode heap){
        // this is the same hack as DebloaterX[OOPSLA'23], due the defect in Qilin framework
