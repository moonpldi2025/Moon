...
public class OAG implements DirectedGraph<AllocNode> {
    ...
    public Set<AllocNode> getPredsOf(AllocNode n) {
        return Collections.unmodifiableSet(predecessors.getOrDefault(n, Collections.emptySet()));
    }

    public Set<AllocNode> getSuccsOf(AllocNode n) {
        return Collections.unmodifiableSet(successors.getOrDefault(n, Collections.emptySet()));
    }
