...
//            System.out.println("Warning: reflection analysis disabled.");
            System.out.println("Reflection log: " + appConfig.REFLECTION_LOG);

            Options.v().setPhaseOption("cg", "reflection-log:" + appConfig.REFLECTION_LOG);
        }else{
            System.err.println("reflection log is null.");
        }
